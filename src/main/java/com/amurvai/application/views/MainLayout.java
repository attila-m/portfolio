package com.amurvai.application.views;


import com.amurvai.application.views.about.AboutView;
import com.amurvai.application.views.hello.HelloView;
import com.amurvai.application.views.list.ListView;
...
public class MainLayout extends AppLayout {
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Hello", "la la-angle-right", HelloView.class), //

                new MenuItemInfo("List", "la la-angle-right", ListView.class), //

                new MenuItemInfo("About", "la la-angle-right", AboutView.class), //
